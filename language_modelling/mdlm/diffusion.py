...
class Diffusion(L.LightningModule):
  def __init__(
    ...
    if self.config.backbone == 'dit':
      ...
      self.backbone = models.modeling_mdlm.MDLM.from_pretrained(
        config.eval.checkpoint_path,
        trust_remote_code=True,
        **pretrained_kwargs(config.eval.checkpoint_path))
    else:
      raise ValueError(
    ...
    self.eval_model_tokenizer = transformers.AutoTokenizer.\
      from_pretrained(
        ...
        **pretrained_kwargs(self.gen_ppl_eval_model_name_or_path))
  ...
  def compute_generative_perplexity(
    ...
    eval_model = transformers.AutoModelForCausalLM.from_pretrained(
      self.gen_ppl_eval_model_name_or_path,
      **pretrained_kwargs(self.gen_ppl_eval_model_name_or_path)).eval()
